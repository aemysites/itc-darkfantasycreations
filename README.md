...
## Environments
- Preview: https://main--itc-darkfantasycreations--aemysites.aem.page/
- Live: https://main--itc-darkfantasycreations--aemysites.aem.live/
- Block Library: https://main--itc-darkfantasycreations--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-darkfantasycreations` directory in your favorite IDE and start coding :)
